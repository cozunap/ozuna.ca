import {
  selectSvgElement
} from "./chunk-UPTHOI3F.js";
import {
  computeDimensionOfText
} from "./chunk-F3YM65HW.js";
import "./chunk-JD5HQBUG.js";
import {
  cleanAndMerge
} from "./chunk-ISRU6UKN.js";
import "./chunk-U6OELGPM.js";
import {
  clear,
  configureSvgSize,
  ...
  setAccTitle,
  setDiagramTitle
} from "./chunk-XPKXU3PH.js";
import {
  band,
  line_default,
  linear,
  log
} from "./chunk-XQQXSJPC.js";
import {
  __name
} from "./chunk-IJOGDVNM.js";
import "./chunk-OCBYBPSH.js";

// node_modules/mermaid/dist/chunks/mermaid.core/xychartDiagram-S5SC5T6Z.mjs
var parser = (function() {
...
var LEGEND_MARKER_TO_FONT_RATIO = 0.75;
var LEGEND_ITEM_SPACING_TO_FONT_RATIO = 0.5;
var LEGEND_MARKER_SPACING_TO_FONT_RATIO = 0.35;
function getLegendLayout(fontSize) {
  return {
    fontSize,
...
var ChartLegend = (_a6 = class {
  ...
  calculateSpace(availableSpace) {
    this.visiblePlots = this.chartConfig.showLegend ? this.chartData.plots.filter((plot) => plot.title) : [];
    ...
    const widthRequired = this.chartConfig.legendPadding * 2 + markerSize + markerSpacing + textDimension.width;
    const heightRequired = this.chartConfig.legendPadding * 2 + this.visiblePlots.length * fontSize + (this.visiblePlots.length - 1) * itemSpacing;
...
}, __name(_a6, "ChartLegend"), _a6);
function getChartLegendComponent(chartConfig, chartData, chartThemeConfig, tmpSVGGroup2) {
  const textDimensionCalculator = new TextDimensionCalculatorWithFont(tmpSVGGroup2);
...
}, __name(_a7, "LinePlot"), _a7);
var _a8;
var BarPlot = (_a8 = class {
...
}, __name(_a8, "BarPlot"), _a8);
var _a9;
var BasePlot = (_a9 = class {
...
var Orchestrator = (_a10 = class {
  constructor(chartConfig, chartData, chartThemeConfig, tmpSVGGroup2) {
    ...
    this.componentStore = {
      ...
      legend: getChartLegendComponent(chartConfig, chartData, chartThemeConfig, tmpSVGGroup2),
      xAxis: getAxis(
        chartData.xAxis,
        chartConfig.xAxis,
        {
...
}, __name(_a10, "Orchestrator"), _a10);
var _a11;
var XYChartBuilder = (_a11 = class {
...
}, __name(_a11, "XYChartBuilder"), _a11);
var plotIndex = 0;
var tmpSVGGroup;
...
//# sourceMappingURL=xychartDiagram-S5SC5T6Z-LBUV4X7P.js.map
