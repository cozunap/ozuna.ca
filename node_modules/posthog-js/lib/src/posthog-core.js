...
var blocked_uas_1 = require("@posthog/browser-common/utils/blocked-uas");
var device_model_utils_1 = require("@posthog/browser-common/utils/device-model-utils");
...
var browser_client_1 = require("./extensions/browser-client");
var instances = {};
...
var RESET_CONSENT_WARN = 'reset() cleared the stored consent, and capturing is now off because of `opt_out_capturing_by_default`. ' +
...
var FLAG_CALLED_TRANSPORT_PROPERTY_KEYS = ['token', 'distinct_id', constants_1.COOKIELESS_MODE_FLAG_PROPERTY];
...
var defaultsThatVaryByConfig = function (defaults) { return ({
    ...
    session_recording: defaults && defaults >= '2026-06-25'
...
var configRenames = function (origConfig) {
    ...
    var newConfig = (0, general_utils_1.extend)({}, renames, origConfig);
    ...
    var previewExternalDependencyVersionedPaths = origConfig.__preview_external_dependency_versioned_paths;
    if (!(0, core_1.isUndefined)(previewExternalDependencyVersionedPaths)) {
        if ((0, core_1.isUndefined)(origConfig.strict_script_versioning)) {
            newConfig.strict_script_versioning = !!previewExternalDependencyVersionedPaths;
        }
        if ((0, core_1.isString)(previewExternalDependencyVersionedPaths) && (0, core_1.isUndefined)(origConfig.asset_host)) {
...
var PostHog = /** @class */ (function () {
    ...
    function PostHog() {
        ...
        this._sessionRegisteredPropKeys = new Set();
        this._sessionRegisteredPropertiesStorageKey = '';
        this._internalEventEmitter = new simple_event_emitter_1.SimpleEventEmitter();
        this._extensions = [];
        this._extensionEventPropertyProducers = [];
     ...
     */
    PostHog.prototype._healCookielessSentinelDistinctId = function () {
        if (this._inCookielessMode() || this.get_distinct_id() !== constants_1.COOKIELESS_SENTINEL_VALUE) {
            return;
        }
        ...
        var currentDistinctId = this.get_distinct_id();
        if (!currentDistinctId || currentDistinctId === constants_1.COOKIELESS_SENTINEL_VALUE) {
            ...
            persistence.set_property(constants_1.USER_STATE, constants_1.USER_STATE_ANONYMOUS);
        }
    ...
    PostHog.prototype._init = function (token, config, name) {
        ...
        if (this.__loaded) {
            ...
            if (normalizedToken !== ((_a = this.config) === null || _a === void 0 ? void 0 : _a.token)) {
        ...
        this.__loaded = true;
        this.config = (0, exports.defaultConfig)(config.defaults); // fully overwritten by set_config right below
        ...
        var mergedConfig = (0, general_utils_1.extend)({}, baseConfig, userConfig, {
            name: name,
        ...
        if ((0, core_1.isObject)(baseConfig.rageclick) && (0, core_1.isObject)(userConfig.rageclick)) {
            mergedConfig.rageclick = (0, general_utils_1.extend)({}, baseConfig.rageclick, userConfig.rageclick);
        }
        ...
        if ((0, core_1.isObject)(baseConfig.session_recording) && (0, core_1.isObject)(userConfig.session_recording)) {
            mergedConfig.session_recording = (0, general_utils_1.extend)({}, baseConfig.session_recording, userConfig.session_recording);
        }
        ...
        var persistenceName = this.config.persistence_name || this.config.token;
        this._sessionRegisteredPropertiesStorageKey = 'ph_' + persistenceName + '_session_registered_properties';
        if (this.config.persistence !== 'memory' && !persistenceDisabled && storage_1.sessionStore._is_supported()) {
            var sessionRegisteredPropKeys = storage_1.sessionStore._parse(this._sessionRegisteredPropertiesStorageKey);
            if ((0, core_1.isArray)(sessionRegisteredPropKeys)) {
                sessionRegisteredPropKeys.forEach(function (key) {
                    if ((0, core_1.isString)(key)) {
                        _this._sessionRegisteredPropKeys.add(key);
                    }
                });
            }
        }
        else {
            storage_1.sessionStore._remove(this._sessionRegisteredPropertiesStorageKey);
        }
        ...
        if (!startInCookielessMode) {
            ...
            this.sessionManager.onSessionId(function (_sessionId, _windowId, changeReason) {
                if ((changeReason === null || changeReason === void 0 ? void 0 : changeReason.activityTimeout) ||
                    (changeReason === null || changeReason === void 0 ? void 0 : changeReason.sessionPastMaximumLength) ||
                    (changeReason === null || changeReason === void 0 ? void 0 : changeReason.crossTabAdoption)) {
                    _this._clearSessionRegisteredProps();
                }
            });
        }
        ...
        if (this.config.identity_distinct_id && !((_b = config.bootstrap) === null || _b === void 0 ? void 0 : _b.distinctID)) {
        ...
        (0, general_utils_1.addEventListener)(globals_1.window, 'onpagehide' in self ? 'pagehide' : 'unload', this._handle_unload.bind(this), {
            passive: false,
        });
        ...
        if (!this.config.disableDeviceModel) {
            (0, device_model_utils_1.getDeviceModel)()
                .then(function (model) {
                var _a;
                if (model) {
                    _this.register((_a = {}, _a[constants_1.DEVICE_MODEL] = model, _a));
                }
            })
                .catch(__NOOP);
        }
    ...
    PostHog.prototype._enrollFeatureFlags = function () {
        var _this = this;
        var _a, _b, _c, _d, _e, _f;
        var FeatureFlagsClass = (_b = (_a = this.config.__extensionClasses) === null || _a === void 0 ? void 0 : _a.featureFlags) !== null && _b !== void 0 ? _b : (_c = PostHog.__defaultExtensionClasses) === null || _c === void 0 ? void 0 : _c.featureFlags;
        if (!FeatureFlagsClass) {
            return;
        }
        if (!this.featureFlags || !(this.featureFlags instanceof FeatureFlagsClass)) {
            (_d = this._featureFlagsReloadingUnsubscribe) === null || _d === void 0 ? void 0 : _d.call(this);
            this._featureFlagsReloadingUnsubscribe = undefined;
            this.featureFlags = new FeatureFlagsClass(this);
        }
        if ((0, core_1.isFunction)(this.featureFlags.onReloading) && (0, core_1.isFunction)(this.featureFlags.setup)) {
            if (!this._featureFlagsReloadingUnsubscribe) {
                this._featureFlagsReloadingUnsubscribe = this.featureFlags.onReloading(function () {
                    _this._internalEventEmitter.emit('featureFlagsReloading', true);
                });
                void this._getBrowserClientAdapter().add(this.featureFlags);
            }
        }
        else {
            (_f = (_e = this.featureFlags).initialize) === null || _f === void 0 ? void 0 : _f.call(_e);
        }
    };
    PostHog.prototype._initExtensions = function (startInCookielessMode) {
        ...
        if (ext.exceptions) {
            this._extensions.push((this.exceptions = (_a = this.exceptions) !== null && _a !== void 0 ? _a : new ext.exceptions(this)));
        }
        ...
        if (ext.surveys) {
            this._extensions.push((this.surveys = (_b = this.surveys) !== null && _b !== void 0 ? _b : new ext.surveys(this)));
        }
        if (ext.logs) {
            this._extensions.push((this.logs = (_c = this.logs) !== null && _c !== void 0 ? _c : new ext.logs(this)));
        }
        if (ext.metrics) {
            this._extensions.push((this.metrics = (_d = this.metrics) !== null && _d !== void 0 ? _d : new ext.metrics(this)));
        }
        ...
        initTasks.push(function () {
            if (_this._pendingRemoteConfig) {
                var result_1 = _this._pendingRemoteConfig;
                _this._pendingRemoteConfig = undefined;
                _this._extensions.forEach(function (ext) { var _a; return (_a = ext.onRemoteConfig) === null || _a === void 0 ? void 0 : _a.call(ext, result_1); });
            }
        });
    ...
    PostHog.prototype._onRemoteConfig = function (result) {
        var _this = this;
        var _a, _b;
        ...
        (_b = this._browserClientAdapter) === null || _b === void 0 ? void 0 : _b.handleRemoteConfig(result);
        // Every legacy extension receives the canonical result and handles failures itself.
        this._extensions.forEach(function (ext) { var _a; return (_a = ext.onRemoteConfig) === null || _a === void 0 ? void 0 : _a.call(ext, result); });
    };
    ...
    PostHog.prototype._dom_loaded = function () {
        var _this = this;
        if (this.is_capturing()) {
            (0, general_utils_1.eachArray)(this.__request_queue, function (item) { return _this._send_retriable_request(item); });
        }
        this.__request_queue = [];
        this._start_queue_if_opted_in();
    };
    PostHog.prototype._handle_unload = function () {
        ...
        (_b = (_a = this.surveys) === null || _a === void 0 ? void 0 : _a.handlePageUnload) === null || _b === void 0 ? void 0 : _b.call(_a);
        // Metrics are pre-aggregated client-side and don't ride the request
        // queue, so the drain must not depend on `request_batching`.
        void ((_c = this.metrics) === null || _c === void 0 ? void 0 : _c.flush('sendBeacon'));
        if (!this.config.request_batching) {
        ...
        (_d = this.logs) === null || _d === void 0 ? void 0 : _d.flushLogs('sendBeacon');
        (_e = this._requestQueue) === null || _e === void 0 ? void 0 : _e.unload();
        (_f = this._retryQueue) === null || _f === void 0 ? void 0 : _f.unload();
    };
    PostHog.prototype._send_request = function (options) {
        ...
        if (this.rateLimiter.isServerRateLimited(options.batchKey)) {
            if (options.fireCallbackOnDrop) {
                (_b = options.callback) === null || _b === void 0 ? void 0 : _b.call(options, { statusCode: 429 });
            }
            return;
        }
    ...
    PostHog.prototype._execute_array = function (array) {
        ...
        try {
            ...
            (0, general_utils_1.eachArray)(array, function (item) {
                if (item) {
                    fn_name_1 = item[0];
            ...
            var execute = function (calls, thisArg) {
                (0, general_utils_1.eachArray)(calls, function (item) {
                    try {
                        if ((0, core_1.isArray)(item[0])) {
                            // chained call
                            var caller_1 = thisArg;
                            (0, general_utils_1.each)(item, function (call) {
    ...
    PostHog.prototype.capture = function (event_name, properties, options) {
        ...
        var uuid = (0, core_1.getEventUuid)(options === null || options === void 0 ? void 0 : options.uuid, uuidv7_1.uuidv7);
        var data = {
            uuid: uuid,
            event: event_name,
        ...
        // the full event.
        var shouldSendMinimalFlagCalledEvent = event_name === '$feature_flag_called' &&
            data.properties['$feature_flag_has_experiment'] === false &&
            this.get_property(constants_1.PERSISTENCE_MINIMAL_FLAG_CALLED_EVENTS) === true;
        ...
        var unsetProperties = options === null || options === void 0 ? void 0 : options.$unset;
        if (unsetProperties) {
        ...
        var setOnceProperties = shouldSendMinimalFlagCalledEvent
            ? undefined
            : this._calculate_set_once_properties(options === null || options === void 0 ? void 0 : options.$set_once, markSetOnceAsSent, forceIncludeInitialProps);
        if (setOnceProperties) {
            data.$set_once = setOnceProperties;
        }
        if (!(options === null || options === void 0 ? void 0 : options._noTruncate)) {
            data = (0, general_utils_1._copyAndTruncateStrings)(data, this.config.properties_string_max_length);
        }
        ...
        if (shouldSendMinimalFlagCalledEvent) {
            data.properties = (0, core_1.minimizeFlagCalledEventProperties)(data.properties, FLAG_CALLED_TRANSPORT_PROPERTY_KEYS);
        }
        ...
        if (!(0, core_1.isNullish)(this.config.before_send)) {
            ...
            if (!beforeSendResult) {
                ...
                // codeql[js/insecure-randomness] Event UUIDs are identifiers for deduplication, not secrets.
                data.uuid = (0, core_1.getEventUuid)(data.uuid, uuidv7_1.uuidv7);
            }
        }
        this._internalEventEmitter.emit('eventCaptured', data);
        var url = (_d = options === null || options === void 0 ? void 0 : options._url) !== null && _d !== void 0 ? _d : this.requestRouter.endpointFor('api', this.analyticsDefaultEndpoint);
        var isSessionRecording = (options === null || options === void 0 ? void 0 : options._batchKey) === 'recordings' || /\/s\/(?:\?|$)/.test(url);
        var requestOptions = {
            method: 'POST',
            url: url,
            data: data,
    ...
    PostHog.prototype._getBrowserClientAdapter = function () {
        var _a;
        return ((_a = this._browserClientAdapter) !== null && _a !== void 0 ? _a : (this._browserClientAdapter = new browser_client_1.BrowserClientAdapter(this)));
    };
    PostHog.prototype._registerExtensionEventProperties = function (producer) {
        var _this = this;
        ...
        return function () {
            ...
            active = false;
            var index = _this._extensionEventPropertyProducers.indexOf(producer);
            if (index !== -1) {
                _this._extensionEventPropertyProducers.splice(index, 1);
            }
        };
    };
    PostHog.prototype._processCookieIdentityChange = function (reloadFeatureFlags) {
        var _a, _b, _c;
        if (reloadFeatureFlags === void 0) { reloadFeatureFlags = true; }
        if (!((_a = this.persistence) === null || _a === void 0 ? void 0 : _a.consumeCookieIdentityChange())) {
            return false;
        }
        this._cachedPersonProperties = null;
        if (this.persistence.get_property(constants_1.USER_STATE) === constants_1.USER_STATE_ANONYMOUS) {
        ...
        (_c = this.featureFlags) === null || _c === void 0 ? void 0 : _c.reset();
    ...
    PostHog.prototype.calculateEventProperties = function (eventName, eventProperties, timestamp, uuid, readOnly) {
        ...
        var infoProperties = (0, event_utils_1.getEventProperties)(this.config.mask_personal_data_properties, this.config.custom_personal_data_properties, this.config.detect_google_search_app, this.config.disable_capture_url_hashes);
        if (this.sessionManager) {
            var _c = this.sessionManager.checkAndGetSessionAndWindowId(readOnly, timestamp.getTime(), true), sessionId = _c.sessionId, windowId = _c.windowId;
            properties['$session_id'] = sessionId;
            properties['$window_id'] = windowId;
        }
        if (this.sessionPropsManager) {
            (0, general_utils_1.extend)(properties, this.sessionPropsManager.getSessionProps());
        }
        try {
            if (this.sessionRecording) {
                (0, general_utils_1.extend)(properties, this.sessionRecording.sdkDebugProperties);
            }
            properties['$sdk_debug_retry_queue_size'] = (_b = this._retryQueue) === null || _b === void 0 ? void 0 : _b.length;
        }
        catch (e) {
        ...
        properties = (0, general_utils_1.extend)(properties, pageviewProperties);
        ...
        var persistenceProperties = this.persistence.properties();
        var sessionPersistenceProperties = this.sessionPersistence.properties();
        (0, general_utils_1.each)(['$referrer', '$referring_domain'], function (referrerKey) {
        ...
        if (this._extensionEventPropertyProducers.length > 0) {
            try {
                for (var _d = __values(this._extensionEventPropertyProducers.slice()), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var producer = _e.value;
                    try {
                        (0, general_utils_1.extend)(dynamicProperties, producer());
                    }
                    catch (error) {
                        logger_1.logger.error('Failed to produce browser extension event properties', error);
                    }
                }
            }
        ...
        properties = (0, general_utils_1.extend)({}, infoProperties, persistenceProperties, sessionPersistenceProperties, __assign(__assign({}, dynamicProperties), properties));
        properties['$is_identified'] = this._isIdentified();
        if ((0, core_1.isArray)(this.config.property_denylist)) {
            (0, general_utils_1.each)(this.config.property_denylist, function (denylisted_prop) {
    ...
    PostHog.prototype._calculate_set_once_properties = function (dataSetOnce, markAsSent, forceIncludeInitialProps) {
        ...
        var setOnceProperties = (0, general_utils_1.extend)({}, initialProps, sessionProps || {}, dataSetOnce || {});
        var sanitize_properties = this.config.sanitize_properties;
        if (sanitize_properties) {
            logger_1.logger.error(SANITIZE_DEPRECATED);
    ...
    PostHog.prototype.register_for_session = function (properties) {
        var _this = this;
        var _a, _b;
        (_a = this.persistence) === null || _a === void 0 ? void 0 : _a.syncCookieProperties();
        this._processCookieIdentityChange();
        (_b = this.sessionPersistence) === null || _b === void 0 ? void 0 : _b.register(properties);
        Object.keys(properties).forEach(function (key) { return _this._sessionRegisteredPropKeys.add(key); });
        this._persistSessionRegisteredPropKeys();
    };
    /**
    ...
    PostHog.prototype._clearSessionRegisteredProps = function () {
        var _this = this;
        this._sessionRegisteredPropKeys.forEach(function (property) {
            var _a;
            (_a = _this.sessionPersistence) === null || _a === void 0 ? void 0 : _a.unregister(property);
        });
        this._sessionRegisteredPropKeys.clear();
        this._persistSessionRegisteredPropKeys();
    };
    PostHog.prototype._persistSessionRegisteredPropKeys = function () {
        var _a;
        if (!this._sessionRegisteredPropertiesStorageKey) {
            return;
        }
        if (this.config.persistence === 'memory' ||
            ((_a = this.sessionPersistence) === null || _a === void 0 ? void 0 : _a._disabled) ||
            !storage_1.sessionStore._is_supported()) {
            storage_1.sessionStore._remove(this._sessionRegisteredPropertiesStorageKey);
            return;
        }
        var registeredProperties = [];
        this._sessionRegisteredPropKeys.forEach(function (property) { return registeredProperties.push(property); });
        if (registeredProperties.length > 0) {
            storage_1.sessionStore._set(this._sessionRegisteredPropertiesStorageKey, registeredProperties);
        }
        else {
            storage_1.sessionStore._remove(this._sessionRegisteredPropertiesStorageKey);
        }
     ...
     */
    PostHog.prototype.getAllFeatureFlags = function () {
        var _a, _b;
        return (_b = (_a = this.featureFlags) === null || _a === void 0 ? void 0 : _a.getAllFeatureFlags()) !== null && _b !== void 0 ? _b : [];
    };
    PostHog.prototype.isFeatureEnabled = function (key, options) {
        var _a, _b;
        return (_b = (_a = this.featureFlags) === null || _a === void 0 ? void 0 : _a.isFeatureEnabled(key, options)) !== null && _b !== void 0 ? _b : options === null || options === void 0 ? void 0 : options.defaultValue;
    };
    /**
    ...
    PostHog.prototype.identify = function (new_distinct_id, userPropertiesToSet, userPropertiesToSetOnce) {
        ...
        var preSyncDistinctId = this.get_distinct_id();
        var identityChangedDuringSync = this.persistence.syncCookieProperties() && this.get_distinct_id() !== preSyncDistinctId;
        ...
        var processedCookieIdentityChange = this._processCookieIdentityChange(false);
        var cookieSyncSuppressionStarted = this.persistence._beginCookieSyncSuppression();
        ...
        try {
            ...
            var identityDidChange = new_distinct_id !== previous_distinct_id;
            var shouldTransitionToIdentified = !identityDidChange && isKnownAnonymous;
            ...
            if (identityDidChange && isKnownAnonymous) {
                ...
                this.persistence.set_property(constants_1.USER_STATE, constants_1.USER_STATE_IDENTIFIED);
                var setProperties = userPropertiesToSet || {};
                var setOnceProperties = userPropertiesToSetOnce || {};
     ...
     */
    PostHog.prototype.unsetPersonProperties = function (propertyNames) {
        var _a;
        var names = ((0, core_1.isArray)(propertyNames) ? propertyNames : [propertyNames]).filter(function (name) { return (0, core_1.isString)(name) && name.length > 0; });
        if (names.length === 0) {
            return;
        }
        ...
        (_a = this.featureFlags) === null || _a === void 0 ? void 0 : _a.unsetPersonPropertiesForFlags(names, true);
    ...
    PostHog.prototype.group = function (groupType, groupKey, groupPropertiesToSet) {
        ...
        (_c = this.persistence) === null || _c === void 0 ? void 0 : _c.syncCookieProperties();
        this._processCookieIdentityChange();
     ...
     */
    PostHog.prototype.resetPersonPropertiesForFlags = function (reloadFeatureFlags) {
        var _a;
        if (reloadFeatureFlags === void 0) { reloadFeatureFlags = true; }
        (_a = this.featureFlags) === null || _a === void 0 ? void 0 : _a.resetPersonPropertiesForFlags(reloadFeatureFlags);
    };
    /**
     ...
     */
    PostHog.prototype.reset = function (options) {
        var reset_device_id = (0, core_1.isBoolean)(options) ? options : options === null || options === void 0 ? void 0 : options.resetDeviceID;
        var bootstrap = (0, core_1.isBoolean)(options) ? undefined : options === null || options === void 0 ? void 0 : options.bootstrap;
        this._reset(reset_device_id, false, bootstrap);
    };
    PostHog.prototype._reset = function (reset_device_id, isConsentTransition, bootstrap) {
        var _a, _b;
        var _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y;
        if (isConsentTransition === void 0) { isConsentTransition = false; }
        logger_1.logger.info('reset');
        if (!this.__loaded) {
            return logger_1.logger.uninitializedWarning('posthog.reset');
        }
        var bootstrapSessionID = bootstrap === null || bootstrap === void 0 ? void 0 : bootstrap.sessionID;
        this.config.bootstrap = bootstrap || ((_c = this._originalUserConfig) === null || _c === void 0 ? void 0 : _c.bootstrap) || {};
        (_e = (_d = this.featureFlags) === null || _d === void 0 ? void 0 : _d.updateConfig) === null || _e === void 0 ? void 0 : _e.call(_d, this.config, this._shouldDisableFlags());
        ...
        var device_model = this.get_property(constants_1.DEVICE_MODEL);
        ...
        var wasCapturing = this.is_capturing();
        this.consent.reset();
        ...
        var cookieSyncSuppressionStarted = (_g = (_f = this.persistence) === null || _f === void 0 ? void 0 : _f._beginCookieSyncSuppression) === null || _g === void 0 ? void 0 : _g.call(_f);
        var resetCompleted = false;
        try {
            (_h = this.persistence) === null || _h === void 0 ? void 0 : _h.clear();
            (_j = this.sessionPersistence) === null || _j === void 0 ? void 0 : _j.clear();
            this._sessionRegisteredPropKeys.clear();
            this._persistSessionRegisteredPropKeys();
            if (!(0, core_1.isUndefined)(recordingRemoteConfig)) {
                (_k = this.persistence) === null || _k === void 0 ? void 0 : _k.register((_a = {}, _a[constants_1.SESSION_RECORDING_REMOTE_CONFIG] = recordingRemoteConfig, _a));
            }
            (_l = this.surveys) === null || _l === void 0 ? void 0 : _l.reset();
            ...
            (_m = this._remoteConfigLoader) === null || _m === void 0 ? void 0 : _m.stop();
            (_o = this.featureFlags) === null || _o === void 0 ? void 0 : _o.reset();
            (_p = this.conversations) === null || _p === void 0 ? void 0 : _p.reset();
            (_q = this.logs) === null || _q === void 0 ? void 0 : _q.reset();
            (_r = this.metrics) === null || _r === void 0 ? void 0 : _r.reset();
            (_s = this.persistence) === null || _s === void 0 ? void 0 : _s.set_property(constants_1.USER_STATE, constants_1.USER_STATE_ANONYMOUS);
            (_t = this.sessionManager) === null || _t === void 0 ? void 0 : _t.resetSessionId();
            this._cachedPersonProperties = null;
            if (this.config.cookieless_mode === constants_1.COOKIELESS_ALWAYS) {
                ...
                if (!reset_device_id && !(0, core_1.isUndefined)(device_model)) {
                    this.register((_b = {}, _b[constants_1.DEVICE_MODEL] = device_model, _b));
                }
            }
            this.register({
            ...
            if (bootstrap) {
                ...
                if (bootstrap.distinctID !== undefined && !this._inCookielessMode()) {
                    (_u = this.persistence) === null || _u === void 0 ? void 0 : _u.set_property(constants_1.USER_STATE, bootstrap.isIdentifiedID ? constants_1.USER_STATE_IDENTIFIED : constants_1.USER_STATE_ANONYMOUS);
                    this.register({ distinct_id: bootstrap.distinctID });
                }
                (_v = this.featureFlags) === null || _v === void 0 ? void 0 : _v.initialize();
                if (!(0, core_1.isUndefined)(bootstrapSessionID) &&
                    !((_w = this.sessionManager) === null || _w === void 0 ? void 0 : _w.setBootstrapSessionId(bootstrapSessionID, true))) {
                    var bootstrapWithoutSessionID = __assign({}, bootstrap);
            ...
            if (cookieSyncSuppressionStarted) {
                ...
                (_y = (_x = this.persistence) === null || _x === void 0 ? void 0 : _x._endCookieSyncSuppression) === null || _y === void 0 ? void 0 : _y.call(_x, resetCompleted);
            }
        }
     ...
     */
    PostHog.prototype.shutdown = function (_shutdownTimeoutMs) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, _d, _e, _f, _g, _h;
            return __generator(this, function (_j) {
                void _shutdownTimeoutMs;
                if (!this.__loaded) {
                    logger_1.logger.uninitializedWarning('posthog.shutdown');
                    return [2 /*return*/];
                }
                (_a = this._remoteConfigLoader) === null || _a === void 0 ? void 0 : _a.stop();
                (_b = this._browserClientAdapter) === null || _b === void 0 ? void 0 : _b.dispose();
                (_c = this.sessionRecording) === null || _c === void 0 ? void 0 : _c.dispose();
                ...
                (_d = this.logs) === null || _d === void 0 ? void 0 : _d.flushLogs('sendBeacon');
                void ((_e = this.metrics) === null || _e === void 0 ? void 0 : _e.flush('sendBeacon'));
                (_f = this._requestQueue) === null || _f === void 0 ? void 0 : _f.unload();
                (_g = this._retryQueue) === null || _g === void 0 ? void 0 : _g.unload();
                try {
                    (_h = this.featureFlags) === null || _h === void 0 ? void 0 : _h.destroy();
                }
                catch (error) {
                    logger_1.logger.error('Error while destroying feature flags', error);
                }
                return [2 /*return*/];
            });
        });
    ...
    PostHog.prototype.set_config = function (config) {
        ...
        if ((0, core_1.isObject)(config)) {
            (0, general_utils_1.extend)(this.config, (0, exports.configRenames)(config));
            ...
            (_c = (_b = this.featureFlags) === null || _b === void 0 ? void 0 : _b.updateConfig) === null || _c === void 0 ? void 0 : _c.call(_b, this.config, this._shouldDisableFlags());
            (_d = this.exceptionObserver) === null || _d === void 0 ? void 0 : _d.onConfigChange();
            (_e = this.exceptions) === null || _e === void 0 ? void 0 : _e.onConfigChange();
            (_f = this.sessionRecording) === null || _f === void 0 ? void 0 : _f.startIfEnabledOrStop();
            (_g = this.tracingHeaders) === null || _g === void 0 ? void 0 : _g.startIfEnabledOrStop();
            (_h = this.autocapture) === null || _h === void 0 ? void 0 : _h.startIfEnabled();
            (_j = this.heatmaps) === null || _j === void 0 ? void 0 : _j.startIfEnabled();
            (_k = this.exceptionObserver) === null || _k === void 0 ? void 0 : _k.startIfEnabledOrStop();
            (_l = this.deadClicksAutocapture) === null || _l === void 0 ? void 0 : _l.startIfEnabledOrStop();
            (_m = this.surveys) === null || _m === void 0 ? void 0 : _m.loadIfEnabled();
            this._sync_opt_out_with_persistence();
            (_o = this.externalIntegrations) === null || _o === void 0 ? void 0 : _o.startIfEnabledOrStop();
        }
    };
    /**
     * @internal
    ...
    PostHog.prototype._captureInitialPageview = function () {
        ...
        if (globals_1.document.visibilityState !== 'visible') {
            if (!this._visibilityStateListener) {
                ...
                (0, general_utils_1.addEventListener)(globals_1.document, constants_1.DOM_EVENT_VISIBILITYCHANGE, this._visibilityStateListener);
            }
            return;
        }
    ...
    PostHog.prototype._shouldDisableFlags = function () {
        ...
        return (0, general_utils_1.migrateConfigField)(originalConfig, 'advanced_disable_flags', 'advanced_disable_decide', false, logger_1.logger);
    };
    PostHog.prototype._runBeforeSend = function (data) {
        ...
        var requiredProperties = Object.keys((_c = data.properties) !== null && _c !== void 0 ? _c : {}).filter(core_1.isKnownUnsafeEditableEventProperty);
        ...
        try {
            for (var fns_1 = __values(fns), fns_1_1 = fns_1.next(); !fns_1_1.done; fns_1_1 = fns_1.next()) {
                ...
                try {
                    ...
                    logger_1.logger.error("Error in beforeSend function for event '".concat(data.event, "':"), e);
                    return null;
                }
            }
        }
        ...
        try {
            ...
            for (var requiredProperties_1 = __values(requiredProperties), requiredProperties_1_1 = requiredProperties_1.next(); !requiredProperties_1_1.done; requiredProperties_1_1 = requiredProperties_1.next()) {
                var property = requiredProperties_1_1.value;
                if (beforeSendResult.properties && (0, core_1.isNullish)(beforeSendResult.properties[property])) {
                    logger_1.logger.warn("Event '".concat(data.event, "' had its '").concat(property, "' property removed in a beforeSend function. This property is required for ingestion, so the event will be dropped."));
                    return null;
                }
            }
        }
            ...
            try {
                if (requiredProperties_1_1 && !requiredProperties_1_1.done && (_b = requiredProperties_1.return)) _b.call(requiredProperties_1);
            }
...
(0, general_utils_1.safewrapClass)(PostHog, ['identify']);
var add_dom_loaded_handler = function () {
    ...
    function dom_loaded_handler() {
        ...
        (0, general_utils_1.each)(instances, function (inst) {
            inst._dom_loaded();
        });
    }
    if (globals_1.document === null || globals_1.document === void 0 ? void 0 : globals_1.document.addEventListener) {
        if (globals_1.document.readyState === 'complete') {
            ...
            (0, general_utils_1.addEventListener)(globals_1.document, 'DOMContentLoaded', dom_loaded_handler, { capture: false });
        }
        return;
    }
...
function init_from_snippet() {
    ...
    var snippetPostHog = globals_2.assignableWindow['posthog'];
    ...
    if (snippetPostHog && !(0, core_1.isArray)(snippetPostHog['_i'])) {
        return;
    }
    ...
    if (snippetPostHog) {
        ...
        var processedSnippetQueues_1 = [];
        (0, general_utils_1.each)(snippetPostHog['_i'], function (item) {
            if (item && (0, core_1.isArray)(item)) {
                ...
                if (instance.__loaded && processedSnippetQueues_1.indexOf(instanceSnippet) === -1) {
                    processedSnippetQueues_1.push(instanceSnippet);
    ...
    ;
    posthogMain.__SV = 1;
    globals_2.assignableWindow['posthog'] = posthogMain;
