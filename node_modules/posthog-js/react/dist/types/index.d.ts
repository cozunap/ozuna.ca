...
import { PostHog, BootstrapConfig, PostHogConfig, JsonType, FeatureFlagResult, CaptureResult } from 'posthog-js';
...
declare function useFeatureFlagEnabled(flag: string, defaultValue: boolean): boolean;
...
declare function captureFeatureInteraction(options: CaptureFeatureOptions): void;
declare function captureFeatureView(options: CaptureFeatureOptions): void;
...
type PostHogErrorBoundaryProps = {
    ...
    additionalProperties?: Properties | ((error: unknown, errorInfo: React__default.ErrorInfo) => Properties);
};
...
export type { PostHogCaptureOnViewedProps, PostHogErrorBoundaryFallbackProps, PostHogErrorBoundaryProps, PostHogFeatureProps };
