    ...
    collections: [
      {
        ...
        fields: [
          ...
          { type: "string", name: "category", label: "Category", options: ["web", "graphic"] },
          { type: "image", name: "image", label: "Image" },
          { type: "string", name: "link", label: "Website Link" },
          { type: "string", name: "description", label: "Description", ui: { component: "textarea" } },
          { type: "image", name: "gallery", label: "Gallery", list: true },
          { type: "string", name: "meta_description", label: "Meta Description" },
      ...
      },
      {
        ...
        fields: [
          { type: "string", name: "title", label: "Title", isTitle: true, required: true },
          { type: "string", name: "meta_description", label: "Meta Description" },
          { type: "string", name: "heroTitle", label: "Hero Title HTML" },
          { type: "image", name: "backgroundVideo", label: "Background Video" },
          {
            type: "object",
            name: "buttons",
            label: "Buttons",
            ...
            fields: [
              ...
              { type: "string", name: "link", label: "Link/File" },
              { type: "boolean", name: "isExternal", label: "Open in new tab?" },
            ],
          },
        ],
      },
      {
        ...
        path: "src/content/pages",
        match: { include: "about" },
        ui: { allowedActions: { create: false, delete: false }, router: () => "/about-me" },
        fields: [
          { type: "string", name: "title", label: "Title", isTitle: true, required: true },
          { type: "string", name: "meta_description", label: "Meta Description" },
          { type: "rich-text", name: "body", label: "Body", isBody: true },
          {
            ...
            fields: [
              ...
              { type: "string", name: "link", label: "URL/File" },
              { type: "boolean", name: "isExternal", label: "Open in new tab?" },
            ],
          },
        ],
      ...
      },
      {
        ...
        fields: [
          ...
          { type: "rich-text", name: "body", label: "Body", isBody: true },
          {
            ...
            fields: [
              { type: "string", name: "text", label: "Button Text" },
              { type: "string", name: "link", label: "Email Address / Link" },
            ],
          },
        ],
      },
          ...
          { type: "string", name: "meta_description", label: "Meta Description" },
          {
            ...
            templates: [
              ...
              },
              {
                name: "text",
                label: "Text Block",
                fields: [{ type: "rich-text", name: "content", label: "Content" }],
              },
              {
                name: "gallery",
                label: "Gallery Block",
