import * as ___posthog_core from './module';
import { PostHog } from './module';
export { PostHog } from './module';
import { Survey, DisplaySurveyType, SurveyPosition, PropertyMatchType, SurveyEventWithFilters, SurveyActionType, Extension as Extension$1, Client, RemoteConfigResult as RemoteConfigResult$1, RemoteConfig, Compression, SessionRecordingRemoteConfig } from '@posthog/browser-common';
...
import { RageclickConfig, DeadClicksAutoCaptureConfig, SupportedWebVitalsMetrics, Properties, CaptureResult, SurveyRenderReason, ToolbarParams, JsonType, FeatureFlagsCallback, FeatureFlagDetail, FeatureFlagResult, FeatureFlagOptions, RemoteConfigFeatureFlagCallback, IsFeatureEnabledOptions, OverrideFeatureFlagsOptions, EarlyAccessFeatureCallback, EarlyAccessFeatureStage, CaptureLogOptions, Logger, CaptureMetricOptions, PostHog as PostHog$1, PostHogConfig as PostHogConfig$1, EventName, RequestResponse } from '@posthog/types';
...
import { ErrorTracking, SurveyResponseValue as SurveyResponseValue$1, SurveyPosition as SurveyPosition$1 } from '@posthog/core';
...
declare const posthog: ___posthog_core.PostHog;

export { DEFAULT_PRODUCT_TOUR_APPEARANCE, ProductTourEventName, ProductTourEventProperties, posthog as default, posthog, severityLevels };
