...
var EXTENSION_URL_PREFIXES = ['chrome-extension://', 'moz-extension://', 'safari-extension:', 'safari-web-extension:'];
...
var PostHogExceptions = /** @class */ (function () {
    ...
    PostHogExceptions.prototype.onRemoteConfig = function (result) {
        var _a;
        var _b, _c, _d;
        if (!result.ok) {
    ...
    PostHogExceptions.prototype.sendExceptionEvent = function (properties) {
        try {
            ...
            var propertiesForExceptionCapture = this._exceptionStepsConfig.enabled && (0, core_1.isNullish)(properties.$exception_steps)
                ...
                : properties;
            var injectedReleaseId = core_1.ErrorTracking.getInjectedReleaseId();
    ...
    PostHogExceptions.prototype._matchesSuppressionRule = function (exceptionList) {
        ...
        try {
            var exceptionValues_1 = exceptionList.reduce(function (acc, _a) {
            ...
            return this._suppressionRules.some(function (rule) {
                var results = rule.values.map(function (v) {
                    ...
                    var values = exceptionValues_1[v.key];
                    if (!compare || !values) {
                        return false;
                    }
    ...
    PostHogExceptions.prototype._isExtensionException = function (exceptionList) {
        ...
        return frames.some(function (_a) {
            var filename = _a.filename;
            return !!filename && EXTENSION_URL_PREFIXES.some(function (prefix) { return filename.startsWith(prefix); });
        });
    };
