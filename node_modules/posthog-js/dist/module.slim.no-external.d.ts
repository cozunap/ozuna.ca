...
import { RageclickConfig, SessionIdChangedCallback, DeadClicksAutoCaptureConfig, SupportedWebVitalsMetrics, Properties, CaptureResult, SurveyRenderReason, ToolbarParams, JsonType, FeatureFlagsCallback, FeatureFlagDetail, FeatureFlagResult, FeatureFlagOptions, RemoteConfigFeatureFlagCallback, IsFeatureEnabledOptions, OverrideFeatureFlagsOptions, EarlyAccessFeatureCallback, EarlyAccessFeatureStage, CaptureLogOptions, Logger, CaptureMetricOptions, PostHog as PostHog$1, PostHogConfig as PostHogConfig$1, EventName, RequestResponse, SeverityLevel, RequestQueueConfig, TreeShakeable, RequestCallback, CaptureOptions as CaptureOptions$1, Property, ResetOptions, ExceptionAutoCaptureConfig } from '@posthog/types';
export { AutocaptureCompatibleElement, AutocaptureConfig, BeforeSendFn, BeforeSendMetricFn, BootstrapConfig, CanvasMaskRegion, CaptureLogOptions, CaptureMetricOptions, CaptureOptions, CaptureResult, CapturedNetworkRequest, ConfigDefaults, DeadClickCandidate, DeadClicksAutoCaptureConfig, DomAutocaptureEvents, EarlyAccessFeature, EarlyAccessFeatureCallback, EarlyAccessFeatureResponse, EarlyAccessFeatureStage, ErrorTrackingOptions, EvaluationReason, EventName, ExceptionAutoCaptureConfig, ExceptionStepsConfig, ExternalIntegrationKind, FeatureFlagDetail, FeatureFlagMetadata, FeatureFlagOptions, FeatureFlagOverrideOptions, FeatureFlagOverrides, FeatureFlagPayloadOverrides, FeatureFlagResult, FeatureFlagsCallback, Headers, HeatmapConfig, InitiatorType, IsFeatureEnabledOptions, JsonRecord, JsonType, KnownEventName, LogAttributeValue, LogAttributes, LogSeverityLevel, Logger, MaskInputOptions, MetricAttributeValue, MetricAttributes, MetricSample, MetricType, MetricsConfig, NetworkRequest, OtlpAnyValue, OtlpKeyValue, OtlpLogRecord, OtlpLogsPayload, OtlpMetricsPayload, OtlpSeverityEntry, OtlpSeverityText, OverrideFeatureFlagsOptions, PerformanceCaptureConfig, Properties, Property, RageclickConfig, RemoteConfigFeatureFlagCallback, RequestCallback, RequestQueueConfig, RequestResponse, ResetOptions, SessionIdChangedCallback, SessionRecordingCanvasOptions, SessionRecordingOptions, SessionRecordingSamplingConfig, SeverityLevel, SlimDOMOptions, SupportedWebVitalsMetrics, SurveyRenderReason, ToolbarParams, ToolbarSource, ToolbarUserIntent, ToolbarVersion } from '@posthog/types';
import { Survey, DisplaySurveyType, SurveyPosition, PropertyMatchType, SurveyEventWithFilters, SurveyActionType, Extension as Extension$1, Client, RemoteConfigResult as RemoteConfigResult$1, RemoteConfig, Compression, SessionRecordingRemoteConfig, Disposable, KeyValueStore, Listener, CapturedEventInfo, DeepReadonly, SessionContext as SessionContext$1, CaptureOptions, SendRequestInit, ApiResponse } from '@posthog/browser-common';
export { ActionStepStringMatching, ActionStepType, BasicSurveyQuestion, Compression, ConversationsRemoteConfig, DisplaySurveyType, ErrorTrackingSuppressionRule, ErrorTrackingSuppressionRuleValue, FlagVariant, LinkSurveyQuestion, MultipleSurveyQuestion, NetworkRecordOptions, PropertyFilters, PropertyMatchType, PropertyOperator, RatingSurveyQuestion, RemoteConfig, SessionRecordingEventTrigger, SessionRecordingRemoteConfig, SessionRecordingTriggerGroup, SessionRecordingTriggerPropertyFilter, SessionRecordingUrlTrigger, Survey, SurveyActionType, SurveyAppearance, SurveyEventName, SurveyEventProperties, SurveyEventType, SurveyEventWithFilters, SurveyPosition, SurveyQuestion, SurveyQuestionBranchingType, SurveyQuestionDescriptionContentType, SurveyQuestionType, SurveySchedule, SurveyTabPosition, SurveyType, SurveyWidgetType, SurveyWithTypeAndAppearance, WidgetPosition } from '@posthog/browser-common';
import { ErrorTracking, SurveyResponseValue as SurveyResponseValue$1, SurveyPosition as SurveyPosition$1, Logger as Logger$1 } from '@posthog/core';
...
declare class SessionIdManager {
    ...
    resetSessionId(): void;
    setBootstrapSessionId(sessionID: string, deferUntilNextSession?: boolean): boolean;
    /**
    ...
    checkAndGetSessionAndWindowId(readOnly?: boolean, _timestamp?: number | null, persistenceAlreadySynced?: boolean): {
        sessionId: string;
        windowId: string;
...
declare class PostHogPersistence {
    ...
    private _lastSeenCookiePropertiesFingerprint;
    private _lastSeenMainCookieValue;
    private _cookieIdentityChangePending;
    private _cookieSyncSuppressed;
    /**
    ...
    private _rememberCurrentCookieProperties;
    /**
    ...
    private _syncCookieProperties;
    consumeCookieIdentityChange(): boolean;
    _beginCookieSyncSuppression(ignoreDisabled?: boolean): boolean;
    _publishSuppressedCookieSnapshot(): void;
    _endCookieSyncSuppression(publish?: boolean): void;
    /**
     ...
     */
    load(allowDisabled?: boolean): void;
...
declare class BrowserClientAdapter implements Client, Disposable {
    readonly instance: PostHog;
    ...
    get session(): SessionContext$1;
    get projectToken(): string;
    add(extension: Extension$1): Promise<void>;
...
declare class PostHog implements PostHogInterface {
    ...
    _sessionRegisteredPropKeys: Set<string>;
    ...
    private readonly _extensionEventPropertyProducers;
    private _browserClientAdapter;
    private _featureFlagsReloadingUnsubscribe;
     ...
     */
    private _healCookielessSentinelDistinctId;
    ...
    private _enrollFeatureFlags;
    private _initExtensions;
    private _processInitTaskQueue;
    _onRemoteConfig(result: RemoteConfigResult): void;
    _loaded(): void;
     ...
     */
    capture(event_name: EventName, properties?: Properties | null, options?: CaptureOptions$1): CaptureResult | undefined;
    ...
    private _processCookieIdentityChange;
    /**
     ...
     */
    shutdown(_shutdownTimeoutMs?: number): Promise<void>;
    /**
...
declare const MetricsExtensions: {
    readonly metrics: typeof PostHogMetrics;
};
...
declare const extensionBundles_d_MetricsExtensions: typeof MetricsExtensions;
...
declare namespace extensionBundles_d {
  export {
    ...
    extensionBundles_d_MetricsExtensions as MetricsExtensions,
...
export { extensionBundles_d as BundleTypes, DEFAULT_PRODUCT_TOUR_APPEARANCE, PostHog, ProductTourEventName, ProductTourEventProperties, posthog as default, posthog, severityLevels };
export type { ConversationsTraits, ConversationsUnavailableReason, ConversationsWidgetState, DisplaySurveyOptions, DisplaySurveyPopoverOptions, ErrorEventArgs, EventHandler, FlagsResponse, GetMessagesResponse, GetTicketsOptions, GetTicketsResponse, JSONContent, MarkAsReadResponse, Message, MessageAuthorType, OverrideConfig, PersistentStore, PostHogConfig, PostHogInterface, ProductTour, ProductTourAppearance, ProductTourBannerConfig, ProductTourButtonAction, ProductTourCallback, ProductTourConditions, ProductTourDismissReason, ProductTourDisplayFrequency, ProductTourRenderReason, ProductTourSelectorError, ProductTourStep, ProductTourStepButton, ProductTourStepButtons, ProductTourStepTranslation, ProductTourStepType, ProductTourSurveyQuestion, ProductTourSurveyQuestionType, ProductTourType, ProductTourWaitPeriod, QueuedRequestWithOptions, RemoteConfigResult, RequestRestoreLinkPayload, RequestRestoreLinkResponse, RequestWithOptions, RestoreFromTokenPayload, RestoreFromTokenResponse, RestoreFromTokenStatus, RetriableRequestWithOptions, SendMessagePayload, SendMessageResponse, SessionContext, SessionRecordingPersistedConfig, SessionStartReason, ShowTourOptions, SiteApp, SiteAppGlobals, SiteAppLoader, SnippetArrayItem, SurveyCallback, SurveyConfig, SurveyElement, SurveyResponseValue, Ticket, TicketStatus, TipTapDoc, TipTapMark, TipTapNode, UserProvidedTraits };
