...
// node_modules/mermaid/dist/chunks/mermaid.core/chunk-TEH6E4GO.mjs
var ELEMENT_NODE = 1;
var TEXT_NODE = 3;
...
var labelHelper = __name(async (parent, node, _classes) => {
  ...
  if (useHtmlLabels) {
    ...
    bbox = await fastdom_default.measure(
...
async function collapsedGroup(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    rect.attr("class", "basic label-container collapsed-group").attr("style", handleUndefinedAttr(node.cssStyles));
  } else {
    rect = shapeSvg.insert("rect", ":first-child");
    rect.attr("class", "basic label-container collapsed-group").attr("style", nodeStyles).attr("rx", RADIUS).attr("ry", RADIUS).attr("x", x).attr("y", y).attr("width", totalWidth).attr("height", totalHeight).attr("fill", fill).attr("stroke", stroke);
  }
...
//# sourceMappingURL=chunk-SOBJVFE6.js.map
