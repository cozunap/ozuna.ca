    ...
    NodeCache = async (dir) => {
      try {
        const [fsModule, pathModule, osModule, cryptoModule] = await Promise.all([
          import("./node_fs-WKHRMX4Z.js"),
          import("./node_path-Q3JXZT3F.js"),
          import("./node_os-T2MU57W2.js"),
          import("./node_crypto-HVC5G4B6.js")
        ]);
        ...
        if (typeof (path == null ? void 0 : path.join) !== "function") {
          console.warn(
