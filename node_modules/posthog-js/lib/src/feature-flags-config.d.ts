...
export declare class MutableFeatureFlagsConfigSource implements FeatureFlagsConfigSource {
    private _snapshot;
    private _loggedEvaluationEnvironmentsDeprecation;
    constructor(config: PostHogConfig, remoteRequestsDisabled?: boolean);
