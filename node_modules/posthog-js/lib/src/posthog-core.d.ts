...
import { type DisplaySurveyOptions, type SurveyCallback, type SurveyRenderReason } from './posthog-surveys-types';
...
import { CaptureLogOptions, CaptureOptions, CaptureResult, Compression, ConfigDefaults, EarlyAccessFeatureCallback, EarlyAccessFeatureStage, EventName, ExceptionAutoCaptureConfig, FeatureFlagsCallback, FeatureFlagOptions, FeatureFlagResult, IsFeatureEnabledOptions, JsonType, PostHogConfig, Properties, Property, QueuedRequestWithOptions, RemoteConfigResult, RequestCallback, ResetOptions, SessionIdChangedCallback, SnippetArrayItem, ToolbarParams, PostHogInterface } from './types';
...
export declare class PostHog implements PostHogInterface {
     ...
     * ```
     */
    get logger(): import("@posthog/types").Logger;
    /**
